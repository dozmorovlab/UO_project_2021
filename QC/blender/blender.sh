...
java -Xmx2g -jar juicer_tools.jar pre -q 1 -r 25000,50000 -j 8 "${INPUT}/primary_merged/half1" "${INPUT}/primary_merged/half1.hic" hg38 
...
java -Xmx2g -jar juicer_tools.jar pre -q 1 -r 25000,50000 -j 8 "${INPUT}/primary_merged/half2" "${INPUT}/primary_merged/half2.hic" hg38
